...
class adLDAP {
    ...
    * @var string
    */   
	protected $accountSuffix = "@technologia.net";
    ...
    * @var string
    */
	protected $baseDn = "OU=Users,OU=ESSPL-BLR,DC=technologia,DC=net"; 
    ...
    * @var array
    */
    protected $domainControllers = array("10.1.2.21");
    ...
    * @var string
    */
	protected $adminUsername = "test";
    protected $adminPassword = "esspl@123";
